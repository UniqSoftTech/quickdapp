...
export default function GetStartedPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black overflow-hidden font-mono">
      ...
      <div className="w-10/12 sm:w-10/12 md:w-6/12 lg:w-8/12 xl:w-4/12 border bg-transparent rounded-[20px] shadow-2xl p-4 flex flex-col gap-6 z-[2] border-transparent animate-border-spin shadow-custom-shadow">
